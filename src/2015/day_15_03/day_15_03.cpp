...
static inline const std::string directory = R"(2015\input_15\day_15_03\)";
...
void day_15_03() {
	...
	hlp::print(hlp::PrintType::RESULT, "house count with min one present with robot Santa: {}", u_robot_points.size());
}
