...
static inline const std::string directory = R"(2023\input_23\day_23_02\)";
...
[[nodiscard]] static std::pair<games_ty, games_ty> possible_impossible_games(games_ty const& games, int r, int g, int b) {
